@page periph_hrtim  tests/periph_hrtim part of unmerged riot PR

# tests/periph_hrtim part of unmerged riot PR
...
```c
    ...
    /* TD2 output set on master timer period and reset on master CMP1
     * event */
