...
static const adc_conf_t adc_config[] = {
    { .pin = GPIO_PIN(PORT_A, 4), .dev = 1, .chan =  1 }, /* ADC2_IN1   V_1LowP */
    { .pin = GPIO_PIN(PORT_A, 6), .dev = 1, .chan =  3 }, /* ADC2_IN3   V2_LowP */
    { .pin = GPIO_PIN(PORT_C, 5), .dev = 1, .chan = 11 }, /* ADC2_IN11  V_HighP */
    { .pin = GPIO_PIN(PORT_C, 0), .dev = 0, .chan =  6 }, /* ADC12_IN6  I_1Low */
    { .pin = GPIO_PIN(PORT_C, 1), .dev = 0, .chan =  7 }, /* ADC12_IN7  I_2Low */
    { .pin = GPIO_PIN(PORT_C, 2), .dev = 0, .chan =  8 }, /* ADC12_IN8  I_High */
};
