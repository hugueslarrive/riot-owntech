...
#define VH_BREAK        (696U)              /**< 21.6V / 0,031 */
#define VH_START_MIN    (774U)              /**< 24V / 0,031 */
#define VL_MAX          (856U)              /**< 13.7V / 0,016 */
#define VL_BREAK        (887U)              /**< 14.2V / 0,016 */
#define IL_MIN          (2048U)             /**< 0A */
#define IH_BREAK        (2068U)             /**< 0A */
#define IL_MAX          (IL_MIN + 500U)     /**< 5A / 0,01 */
#define IL_BREAK        (IL_MIN + 550U)     /**< 5.5A / 0,01 */
#define T_BREAK         (500U)              /**< 50°C / 0,1 */
#define T_START_MAX     (T_BREAK - 100U)    /**< 40°C / 0,1 */     
/*
 * DC = VL / VH
 ...
 *          theconverter when the safety conditions are met
 *
 * @param[in]  ac   the measure accumulators structure
 */
